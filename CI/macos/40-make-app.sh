...
cp -R $TES3MP_SRC/build/OpenMW.app testbox/OpenMW.app
...
cp $TES3MP_SRC/build/*default.cfg testbox/OpenMW.app/Contents/Resources
...
bake_icns "$TES3MP_SRC/files/tes3mp/tes3mp_logo.png" "$iconset_temp_dir" "testbox/OpenMW.app/Contents/Resources/TES3MP.icns"
...
cp $TES3MP_SRC/AUTHORS.md testbox/OpenMW.app/Contents/Resources/
cp $TES3MP_SRC/tes3mp-credits.md testbox/OpenMW.app/Contents/Resources/
