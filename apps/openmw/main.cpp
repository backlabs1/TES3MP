...
bool parseOptions (int argc, char** argv, OMW::Engine& engine, Files::ConfigurationManager& cfgMgr)
{
    ...
    */
    ...
    Log(Debug::Info) << Utils::getVersionInfo("Dreamweave client", DREAMWEAVE_VERSION, v.mCommitHash, TES3MP_PROTO_VERSION);
    Log(Debug::Info) << "Based on TES3MP version " << TES3MP_VERSION;
